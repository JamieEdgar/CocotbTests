...
def fixed_integer_vector_dot_vector():
    ...
    runner.build(
        sources=sources,
        hdl_toplevel="fixed_integer_vector_dot_vector"
    )

    runner.test(hdl_toplevel="fixed_integer_vector_dot_vector", test_module="fixed_integer_vector_dot_vector_test,")
