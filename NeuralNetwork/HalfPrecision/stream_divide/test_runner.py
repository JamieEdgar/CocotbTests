...
def half_stream_divide():
    ...
    sources = [ files_path / "delay.sv",
                ...
                proj_path / "half_stream_divide.sv"
                ]

    runner = get_runner(sim)
    runner.build(
        sources=sources,
        hdl_toplevel="half_stream_divide",
        build_args=["--timing"]
    )

    runner.test(hdl_toplevel="half_stream_divide", test_module="half_stream_divide_test,")
