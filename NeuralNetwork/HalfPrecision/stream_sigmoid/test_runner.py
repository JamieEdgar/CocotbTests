...
def half_stream_sigmoid():
    ...
    sources = [ files_path / "delay.sv",
                ...
                faster_files_path / "half_stream_sigmoid.sv"
                ]

    runner = get_runner(sim)
    runner.build(
        sources=sources,
        hdl_toplevel="half_stream_sigmoid",
        build_args=["--timing"]
    )

    runner.test(hdl_toplevel="half_stream_sigmoid", test_module="half_stream_sigmoid_test,")
