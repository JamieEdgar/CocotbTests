...
def half_stream_pade():
    ...
    sources = [ files_path / "delay.sv",
                ...
                proj_path / "half_stream_pade.sv"
                ]

    runner = get_runner(sim)
    runner.build(
        sources=sources,
        hdl_toplevel="half_stream_pade"
    )

    runner.test(hdl_toplevel="half_stream_pade", test_module="half_stream_pade_test,")
